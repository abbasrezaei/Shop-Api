...
namespace Shop.Domain.SellerAgg
{
    public class Seller : AggregateRoot
    {
        ...
        public string NationaCode { get; private set; }
        ...
        public void AddInventory(SellerInventory inventory)
        {
            if (Inventories.Any(p => p.ProductId == inventory.ProductId))
                throw new InvalidDomainDataException("این محصول قبلا اضافه شده است");
        ...
        {
            var currentInventory = Inventories.FirstOrDefault(p => p.Id == newInventory.Id);
